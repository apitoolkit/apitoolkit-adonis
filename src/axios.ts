...
import { APIToolkitMiddleware, asyncLocalStorage } from "./Middleware/APIToolkitMiddleware";
import { APIToolkitConfig } from "@ioc:APIToolkit";
...
export const onResponse =
    (
        ...
        (response: AxiosResponse): AxiosResponse => {
            ...
            const ATConfig: APIToolkitConfig = asyncLocalStorage.getStore()!.get("AT_config");
...
export const onResponseError =
    (
        ...
        (error: AxiosError): Promise<AxiosError> => {
            ...
            const project_id = asyncLocalStorage.getStore()!.get("AT_project_id");
            const ATClient: APIToolkitMiddleware = asyncLocalStorage
                .getStore()!
                .get("AT_client");
            const ATConfig: APIToolkitConfig = asyncLocalStorage.getStore()!.get("AT_config");
            const parent_id: string = asyncLocalStorage.getStore()!.get("AT_msg_id");
